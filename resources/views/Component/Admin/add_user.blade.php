...
@section('breadcrumb', 'Add New User')
...
<div class="form-container">
    <div class="form-card">
        <h2><i class="fas fa-user-plus" style="color:#00d4ff;"></i> Add New User</h2>
        <p class="subtitle">Fill in the details to create a new system user account.</p>
        ...
        <form method="POST" action="{{ route('admin.users.store') }}">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" class="form-control" placeholder="+92 123 4567890" value="{{ old('phone') }}">
                </div>
            </div>
